...
[System.Serializable]
public class SnackInstanceData
{
    ...
    [Header("유통기한 관련")]
    public int purchaseDay = -1; // 구매한 날짜 (총 경과 일수, -1은 구매일 미설정)
    public int shelfLifeDays = 5; // 유통기한 (일수)


    public SnackInstanceData(string itemID, string itemName, Sprite icon, string description, float itemStat, int slotNum)
    {
        this.itemID = itemID;
        ...
        this.purchaseDay = -1; // 기본값: 구매일 미설정
        this.shelfLifeDays = 5; // 기본 유통기한 5일
    }
