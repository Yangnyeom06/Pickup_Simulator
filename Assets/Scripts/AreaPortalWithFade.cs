...
public class AreaPortalWithFade : MonoBehaviour
{
    ...
    [SerializeField] private Transform target;          // �̵��� ��ġ(�ʼ�)

    [Header("Player Transform Changes")]
    [SerializeField] private Vector3 targetScale = Vector3.one;  // �̵� �� ������
    [SerializeField] private bool alignToTargetRotation = false; // Ÿ�� ȸ�� ����
    [SerializeField] private bool keepYRotationOnly = false;     // Y ȸ���� ����
    ...
    [Header("References")]
    [SerializeField] private FadeInOut fade;            // ���� �ִ� FadeInOut ����(�ʼ�)
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            Debug.LogWarning($"[AreaPortalWithFade:{name}] target �Ǵ� fade ������ ��� �ֽ��ϴ�.");
            return;
        }

        busy = true;

        // FadeInOut�� ������ ���¿��� �� ��(Action)���� �ڷ���Ʈ ������ �ѱ��.
        // ���̵� �ƿ� �� onComplete(�����̵� ����) �� ���̵� �� ������ ������. :contentReference[oaicite:1]{index=1}
